...
#Radar long name
RADAR_LONG = 'ncas-mobile-x-band-radar-2'
...
INPUT_DIR = '/gws/smf/j07/ncas_radar/data/ncas-mobile-x-band-radar-2/woest/raw_data/'

# Output directory for netcdf files (specified in the params file)
OUTPUT_DIR = f'/gws/smf/j07/ncas_radar/data/ncas-mobile-x-band-radar-2/{PROJ_NAME}/cfradial/uncalib_v1'
